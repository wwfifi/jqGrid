...
$.jgrid.extend({
	...
	GridNav : function() {
		return this.each(function () {
			...
			$t.p.knv = $t.p.id + "_kn";
			var selection = $("<span style='width:0px;height:0px;background-color:black;' tabindex='0'><span tabindex='-1' style='width:0px;height:0px;background-color:grey;display:none;' id='"+$t.p.knv+"'></span></span>"),
			i, kdir;
